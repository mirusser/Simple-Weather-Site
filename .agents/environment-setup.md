# Environment Setup for Simple-Weather-Site
...
This is a **.NET 10** microservices solution with 46 projects, Docker Compose deployment, gRPC, and a Razor Pages frontend. The key tools required are:
...
npm 9.2.0                  ✅
node v18.20.4              ✅
dotnet restore             ✅ (all 46 projects restored)
dotnet build               ✅ (0 errors, 111 warnings — all pre-existing nullable ref warnings)
```
